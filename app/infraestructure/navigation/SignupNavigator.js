...
import { SubscriptionStack } from '../../features/welcome/screens/SubscriptionStack';
...
const SignupNavigator = () => {
  return (
    <Stack.Navigator initialRouteName="SignupStep1">
      ...
      <Stack.Screen name="SubscriptionStack" component={SubscriptionStack} options={{ headerShown: false }} />
